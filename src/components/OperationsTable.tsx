                ...
                {!collapsedGroups[group] && (
                  <div className="divide-y divide-gray-100">
                    {ops.map((op) => (
                      <div
                        key={op.id}
                        className="group relative flex items-center justify-between p-5 hover:bg-gray-50 transition-colors duration-150"
                      >
                        ...
                        <div className="flex items-center pl-4 border-l border-gray-100 ml-4">
                          <div
                            className={`text-base font-bold ${titleColor} mr-6 whitespace-nowrap`}
                          >
